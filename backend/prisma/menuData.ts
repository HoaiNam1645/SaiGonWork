...
export const MENU: CategorySeed[] = [
  ...
  },
  {
    ...
    dishes: [
      { slug: 'gemischter-salat', nameVi: 'Gemischter Salat',      descriptionVi: null, price: 7.90, imageUrl: IMG('salat') },
      { slug: 'tomatensalat',     nameVi: 'Tomatensalat',          descriptionVi: null, price: 7.90, imageUrl: IMG('salat') },
      { slug: 'haehnchen-salat',  nameVi: 'Hühnerfleisch-Salat',   descriptionVi: null, price: 8.90, imageUrl: IMG('salat') },
      { slug: 'garnelen-salat',   nameVi: 'Garnelen-Salat',        descriptionVi: null, price: 8.90, imageUrl: IMG('salat') },
    ],
  },
  {
    slug: 'hauptgerichte', nameVi: 'Hauptgerichte', nameEn: 'Main dishes', displayOrder: 4,
    dishes: [
      { slug: 'pho',               nameVi: 'Pho',                        descriptionVi: 'Traditionelle 5-Kräuter-Brühe, Reisbandnudel-Suppe mit frischem Koriander, Frühlingszwiebeln und Sojasprossen', price: 13.90, imageUrl: IMG('pho'), isFeatured: true, variants: VAR_PHO },
      { slug: 'pho-xao',           nameVi: 'Pho Xao',                    descriptionVi: 'Gebratene Reisbandnudeln mit Gemüse', price: 13.90, imageUrl: IMG('pho-xao'), variants: VAR_PHO },
      { slug: 'bun-bo-nam-bo',     nameVi: 'Bun Bo Nam Bo',              descriptionVi: 'Reisnudeln, Salat, hausgemachte Soße, geröstete Schalotten, Erdnüsse, Gurke, Koriander, Sojasprossen, Rindfleisch', price: 15.90, imageUrl: IMG('bun-bo-nam-bo'), isFeatured: true },
      { slug: 'bun-nem-chay',      nameVi: 'Bun Nem Chay',               descriptionVi: 'Frittierte vegane Frühlingsrollen auf warmen Reisnudeln mit Wildkräuter-Salat, verfeinert mit Koriander, gerösteten Zwiebeln und zerstoßenen Erdnüssen, serviert mit Sojasoße', price: 13.90, imageUrl: IMG('bun-nem-chay') },
      { slug: 'bun-tofu',          nameVi: 'Bun Tofu',                   descriptionVi: 'Im Wok gebratener Bio-Tofu auf warmen Reisnudeln mit Sojasprossen, Karotten, Wildkräuter-Salat, verfeinert mit Koriander, gerösteten Zwiebeln und zerstoßenen Erdnüssen, serviert mit Sojasoße', price: 13.90, imageUrl: IMG('bun-tofu') },
      { slug: 'thai-curry',        nameVi: 'Thai Curry',                 descriptionVi: 'Zu Reis — Gemüse, Chili, Salat, Zitronengras', price: 11.90, imageUrl: IMG('thai-curry'), isFeatured: true, variants: VAR_SAUCE },
      { slug: 'kung-pao',          nameVi: 'Kung Pao Soße',              descriptionVi: 'Grünes Gemüse, Reis', price: 11.90, imageUrl: IMG('kung-pao'), variants: VAR_SAUCE },
      { slug: 'suess-sauer-ananas', nameVi: 'Süß-sauer Soße mit Ananas', descriptionVi: 'Grünes Gemüse, Reis', price: 11.90, imageUrl: IMG('suess-sauer-ananas'), variants: VAR_SAUCE },
      { slug: 'mango-sosse',       nameVi: 'Mango Soße',                 descriptionVi: 'Grünes Gemüse, Reis', price: 11.90, imageUrl: IMG('mango-sosse'), variants: VAR_SAUCE },
      { slug: 'erdnuss-sosse',     nameVi: 'Erdnuss Soße',               descriptionVi: 'Grünes Gemüse, Reis', price: 11.90, imageUrl: IMG('erdnuss-sosse'), variants: VAR_SAUCE },
      { slug: 'eier-reis',         nameVi: 'Gebratene Eier-Reis-Gerichte', descriptionVi: 'Gebratener Reis mit Ei', price: 10.90, imageUrl: IMG('eier-reis'), variants: VAR_REIS_NUDEL },
      { slug: 'nudel-gerichte',    nameVi: 'Gebratene Nudelgerichte',    descriptionVi: 'Gebratene Nudeln mit Ei, Sojasprossen und Zwiebeln', price: 10.90, imageUrl: IMG('nudel-gerichte'), variants: VAR_REIS_NUDEL },
      { slug: 'yaki-udon',         nameVi: 'Yaki Udon',                  descriptionVi: 'Mit Gemüse, Karotten, Sojasprossen, Frühlingszwiebeln, Paprika', price: 12.00, imageUrl: IMG('yaki-udon'), variants: VAR_UDON },
      { slug: 'pad-thai',          nameVi: 'Pad Thai',                   descriptionVi: 'Gebratene Reisbandnudeln nach Thai-Art mit Erdnüssen und Limette', price: 11.90, imageUrl: IMG('pad-thai'), isFeatured: true, variants: VAR_SAUCE },
      { slug: 'bo-kho-chay',       nameVi: 'Bo Kho Chay (vegan)',        descriptionVi: 'Veganes vietnamesisches „Beef“-Stew mit Zitronengras (wenig scharf) — Pilze, Shiitake, Karotten, Enoki, Kräuterseitling, Tofu. Mit Salat, Gurke, Tomate', price: 14.90, imageUrl: IMG('bo-kho-chay'), isFeatured: true, variants: VAR_REIS_BUN },
      { slug: 'ga-xao-sa-ot',      nameVi: 'Ga Xao Sa Ot',               descriptionVi: 'Gebratenes Hähnchen mit Zitronengras und Chili. Mit Salat, Gurke, Tomate', price: 14.90, imageUrl: IMG('ga-xao-sa-ot'), variants: VAR_REIS_BUN },
