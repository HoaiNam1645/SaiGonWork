...
const de: Dict = {
  ...
  'auth.permission_denied': 'Berechtigung "{{key}}" fehlt.',
  'role.not_found':           'Rolle nicht gefunden.',
  'role.key_taken':           'Rollenschlüssel bereits vergeben.',
  'role.key_invalid':         'Rollenschlüssel ungültig.',
  'role.system_immutable':    'System-Rolle kann nicht geändert/gelöscht werden.',
  'role.has_users':           'Rolle hat noch {{count}} Benutzer — bitte zuerst entfernen.',
  'role.invalid_permission_ids': 'Ungültige Berechtigungs-IDs.',
  'role.invalid_ids':         'Ungültige Rollen-IDs.',
...
const en: Dict = {
  ...
  'auth.permission_denied': 'Missing permission "{{key}}".',
  'role.not_found':           'Role not found.',
  'role.key_taken':           'Role key is already taken.',
  'role.key_invalid':         'Invalid role key.',
  'role.system_immutable':    'System role cannot be modified/deleted.',
  'role.has_users':           'Role still has {{count}} user(s) — remove assignments first.',
  'role.invalid_permission_ids': 'Invalid permission ids.',
  'role.invalid_ids':         'Invalid role ids.',
